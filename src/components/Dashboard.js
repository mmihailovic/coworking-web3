...
function myTicketsChange() {
 ...
 function walletChange() {
    ...
    btn2.classList.remove('inactive');
    btn1.classList.remove('intactive');
    document.getElementById("img1").src = monitorDesktop;
    document.getElementById("img2").src = ticket;
  ...
  return (
    <div className="container">
        ...
        <div  className='buttonContainer' id="btn2Container"><button id='btn2' onClick={myTicketsChange}><img id="img2" src={ticket} alt='?'/>Notifications</button></div>
